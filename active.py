...
def plot_sigmoid():
    ...
    # plt.show()#显示绘图
    plt.savefig('C:/Users/Administrator/Desktop/sigmoid.png', dpi=600, format="png")
# 2.2 定义绘制函数tanh函数
def plot_tanh():
    x = np.arange(-10, 10, 0.1)
    y = tanh(x)
    ...
    plt.tight_layout()
    # plt.show()
    plt.savefig('C:/Users/Administrator/Desktop/tanh.png', dpi=600, format="png")
# 2.3 定义绘制函数relu函数
def plot_relu():
    x = np.arange(-10, 10, 0.1)
    y = relu(x)
    ...
    plt.tight_layout()
    # plt.show()
    plt.savefig('C:/Users/Administrator/Desktop/relu.png', dpi=600, format="png")
# 2.4 定义绘制函数prelu函数
def plot_prelu():
    x = np.arange(-10, 10, 0.1)
    y = prelu(x)
