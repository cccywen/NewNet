...
def main():
    ...
    a = "/home/caoyiwen/slns/NewNet/config/vaihingen/abc1.py"
    # a = "/home/caoyiwen/slns/NewNet/config/potsdam/abc1.py"
    config = py2cfg(a)

    seed_everything(42)

    checkpoint_callback = ModelCheckpoint(save_top_k=3, monitor=config.monitor,
    ...
    if config.pretrained_ckpt_path:
        model = Supervision_Train.load_from_checkpoint(config.pretrained_ckpt_path, config=config)  # 加载checkpoint
    ...
    # trainer = pl.Trainer(gpus=4)  多gpu训练
