...
from geoseg.models.BANet18 import BANet
...
gpus = [0]
strategy = None
# pretrained_ckpt_path = '/home/caoyiwen/slns/NewNet/model_weights/vaihingen/duc-e80/duc-e80-v3.ckpt'
pretrained_ckpt_path = None
resume_ckpt_path = None
#  define the network
net = BANet(n_class=num_classes)
...
train_dataset = VaihingenDataset(data_root='/home/caoyiwen/data/vai_test/train', mode='train',
                                 img_dir='images_1024', mask_dir='masks_1024', img_size=(1024, 1024),
                                 mosaic_ratio=0.25, transform=train_aug)

val_dataset = VaihingenDataset(data_root='/home/caoyiwen/data/vai_test/val', img_dir='images_1024', mask_dir='masks_1024', img_size=(1024, 1024),
                               transform=val_aug)
test_dataset = VaihingenDataset(data_root='/home/caoyiwen/data/vai_test/test', img_dir='images_1024', mask_dir='masks_1024', img_size=(1024, 1024),
                                transform=val_aug)
