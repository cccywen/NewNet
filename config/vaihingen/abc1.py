...
classes = CLASSES
weights_name = "abc-newww-e80"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "abc-newww-e80-v1"
...
gpus = [0]
strategy = None
# pretrained_ckpt_path = '/home/caoyiwen/slns/NewNet/model_weights/vaihingen/bepool-e120/bepool-e120-v2.ckpt'
