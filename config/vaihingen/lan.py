...
gpus = [0]
strategy = None
# pretrained_ckpt_path = '/home/caoyiwen/slns/NewNet/model_weights/vaihingen/manfpn8-e100-799/manfpn8-e100-799.ckpt'
...
loss = LANLoss(ignore_index=ignore_index)
