...
from geoseg.losses.useful_loss import NewULoss
...
classes = CLASSES
# weights_name = "asfnewloss-e90"
weights_name = "fcn-e60"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "fcn-e60-8151"
...
gpus = [0]
strategy = None
# pretrained_ckpt_path = '/home/caoyiwen/slns/NewNet/model_weights/vaihingen/asf-e90-827/asf-e90-8295.ckpt'
...
loss = NewULoss(ignore_index=ignore_index)
