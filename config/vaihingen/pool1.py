...
from geoseg.models.PoolNet import build_model
...
classes = CLASSES
weights_name = "poolu1-new-e100"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "poolu1-new-e100-v3"
...
gpus = [0]
strategy = None
# pretrained_ckpt_path = '/home/caoyiwen/slns/NewNet/model_weights/vaihingen/pool1-e100/pool1-e100.ckpt'
pretrained_ckpt_path = None
resume_ckpt_path = None
# define the network
# net = BESNet(nclass=num_classes, aux=False, pretrained=True)
net = build_model(base_model_cfg='resnet')
