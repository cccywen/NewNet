...
from geoseg.models.UFormer import Uformer
...
classes = CLASSES
weights_name = "uformer-e200"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "uformer-e200-v2"
...
gpus = [0]
strategy = None
pretrained_ckpt_path = '/home/caoyiwen/slns/NewNet/model_weights/vaihingen/uformer-e100/uformer-e100-739.ckpt'
# pretrained_ckpt_path = None
resume_ckpt_path = None
# define the network
# net = BESNet(nclass=num_classes, aux=False, pretrained=True)
net = Uformer(img_size=512, num_classes=num_classes, embed_dim=16, win_size=8, mlp_ratio=4., token_projection='linear', token_mlp='leff', modulator=True, shift_flag=False)
...
base_optimizer = torch.optim.AdamW(net_params, lr=lr, weight_decay=0.02)
