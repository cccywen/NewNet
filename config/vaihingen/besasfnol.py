...
from geoseg.models.BESASF import PoolUNet
...
classes = CLASSES
weights_name = "besasf_nol-e100"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "besasf_nol-e100-v3"
...
gpus = [0]
strategy = None
# pretrained_ckpt_path = '/home/caoyiwen/slns/NewNet/model_weights/vaihingen/besasf_nol-e90/besasf_nol-813.ckpt'
