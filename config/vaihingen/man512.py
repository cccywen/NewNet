...
from geoseg.models.MANPSPUnet import PoolUNet
...
classes = CLASSES
weights_name = "manpsp512-e70"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "manpsp512-e70-v2"
...
gpus = [0]
strategy = None
# pretrained_ckpt_path = '/home/caoyiwen/slns/NewNet/model_weights/vaihingen/manfpn53-e80/manfpn53-e80-8257.ckpt'
...
train_dataset = VaihingenDataset(data_root='/home/caoyiwen/data/vaihingen_512/train', mode='train',
                                 img_dir='images_512', mask_dir='masks_512', img_size=(512, 512),
