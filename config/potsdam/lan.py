...
from geoseg.models.LANet import LANet
...
# pretrained_ckpt_path = '/home/caoyiwen/slns/NewNet/model_weights/potsdam/manfpn5-e100-867/manfpn5-e100-867.ckpt'
...
val_dataset = VaihingenDataset(data_root='/home/caoyiwen/data/potsdam_new/val_new', img_dir='images_1024', mask_dir='masks_1024', img_size=(1024, 1024),
                               transform=val_aug)
