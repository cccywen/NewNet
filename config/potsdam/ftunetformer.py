...
weights_name = "ftunetformer-neww-e45"
weights_path = "model_weights/potsdam/{}".format(weights_name)
test_weights_name = "ftunetformer-neww-e45"
...
train_dataset = PotsdamDataset(data_root='data/potsdam_new/train', mode='train',
                               mosaic_ratio=0.25, transform=train_aug)

val_dataset = PotsdamDataset(transform=val_aug)
test_dataset = PotsdamDataset(data_root='data/potsdam_new/test',
                              transform=val_aug)
