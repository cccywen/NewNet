...
from geoseg.models.BESOnly import PoolUNet
...
classes = CLASSES
weights_name = "besonly-e60"
weights_path = "model_weights/potsdam/{}".format(weights_name)
test_weights_name = "besonly-e60-860"
...
# pretrained_ckpt_path = '/home/caoyiwen/slns/NewNet/model_weights/potsdam/be-pre-e100/be-pre-e100-v1.ckpt'

resume_ckpt_path = None
# define the network
# net = BESNet(nclass=num_classes, aux=False, pretrained=True)
net = PoolUNet(n_classes=num_classes)

# define the loss 两函数加权和
loss = BESLoss(ignore_index=ignore_index)
...
train_dataset = VaihingenDataset(data_root='/home/caoyiwen/data/potsdam/train', mode='train',
                                 img_dir='images_1024', mask_dir='masks_1024', img_size=(1024, 1024),
                                 mosaic_ratio=0.25, transform=train_aug)

val_dataset = VaihingenDataset(data_root='/home/caoyiwen/data/potsdam/val', img_dir='images_1024', mask_dir='masks_1024', img_size=(1024, 1024),
                               transform=val_aug)
test_dataset = VaihingenDataset(data_root='/home/caoyiwen/data/potsdam/test', img_dir='images_1024', mask_dir='masks_1024', img_size=(1024, 1024),
                                transform=val_aug)
