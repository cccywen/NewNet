...
from geoseg.models.ASFOnly import PoolUNet
...
classes = CLASSES
weights_name = "asfonly-e50"
weights_path = "model_weights/potsdam/{}".format(weights_name)
test_weights_name = "asfonly-e50-861"
...
# pretrained_ckpt_path = '/home/caoyiwen/slns/NewNet/model_weights/potsdam/pool1-pre-e100/pool1-pre-e100-v4.ckpt'
