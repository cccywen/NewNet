...
class VaihingenDataset(Dataset):
    def __init__(self, data_root='/home/caoyiwen/data/vaihingen_512/test', mode='val', img_dir='images_512', mask_dir='masks_512',
                 img_suffix='.tif', mask_suffix='.png', transform=train_aug, mosaic_ratio=0.0,
