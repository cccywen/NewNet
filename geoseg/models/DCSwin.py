...
def dcswin_base(pretrained=True, num_classes=4, weight_path='/home/caoyiwen/pretrained weights/stseg_base.pth'):
...
def dcswin_small(pretrained=True, num_classes=4, weight_path='/home/caoyiwen/pretrained weights/stseg_small.pth'):
