...
from tools.batchnorm import SynchronizedBatchNorm2d
import timm
from backbones.BA_aspp import *
...
#     def __init__(self, n_class, aspp_rates=None, edge_kernel=None, is_train=True,
#                  test_size=[256, 256], aspp_out_dim=256, reduce_dim=128, **kwargs):
#         # super(BANet, self).__init__(n_class, 'resnet50', pooling='max', **kwargs)
...
#             self.aspp = ASPP(self.block_channels[3], aspp_out_dim, aspp_rates, SynchronizedBatchNorm2d)
#             self.head = StackMultiTaskFusion_head(n_class, self.block_channels, reduce_dim, has_aspp=True, aspp_dim=aspp_out_dim)
#         else:
...
class BANet(nn.Module):
    def __init__(self, n_class, batchnorm=nn.BatchNorm2d, aspp_rates=None, edge_kernel=None, is_train=True,
                 test_size=[256, 256], aspp_out_dim=256, reduce_dim=128, **kwargs):
        super(BANet, self).__init__()
