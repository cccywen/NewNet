...
def main():
    ...
    a = "/home/caoyiwen/slns/NewNet/config/vaihingen/baseg.py"
    # a = "/home/caoyiwen/slns/NewNet/config/vaihingen/banet.py"
    # a = "/home/caoyiwen/slns/NewNet/config/vaihingen/uformer.py"
    config = py2cfg(a)
